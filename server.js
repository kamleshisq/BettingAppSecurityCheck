...
//......................FOR user management page .......................//
    ...
    socket.on('voidBET', async(data)=>{
        // data.filterData.status = 'OPEN'
        // console.log(data.filterData.eventId, "data.filterData.eventIddata.filterData.eventIddata.filterData.eventId")
        if(data.filterData.marketName == "All"){
            delete data.filterData.marketName
        }
        ...
        socket.emit("voidBET", {betResult,events,page,refreshStatus:data.refreshStatus, marketsName})
                                                ...
                                                $reduce: {
                                                  ...
                                                  in: {											 
                                                    $cond: {
                                                      ...
                                                      then: {                                                
                                                        $cond: {
                                                          if: { $eq: [ele.roleName, "AGENT"] },
                                                          then: {
                                                            value: {
                                                              $multiply: [
                                                                '$$selection.winAmount',
                                                                { $divide: [ele.myShare, 100] }
                                                              ]
                                                            }                                                   
                                                          },
                        ...
                        selections2:{ 
                            $map: { 
                                ...
                                in: { 
                                    ...
                                    //     }
                                    // },
                                    lossAmount3:{value:"$$selection.lossAmount"},
                                    // {
                                    //     $reduce:{
                                    //         input: { $reverseArray: '$parentArray' },
                                    //         initialValue: { value: 0, flag: true },
                                    ...
                                    //     }
                                    // },
                                    exposure2:{value:"$$selection.exposure"},
                                    // {
                                    //     $reduce:{ 
                                    //         input: { $reverseArray: '$parentArray' },
                                    //         initialValue: { value: 0, flag: true },
    ...
    socket.on('LoginCHeckUSerSIde', async(data) => {
        if(data.loginData.User){
            ...
            console.log(lgoginData, Date.now()  > lgoginData.login_time + (1000 * 5),"lgoginDatalgoginDatalgoginData")
            // if()
            if(lgoginData){
