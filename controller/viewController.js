...
exports.getmarketDetailsByMarketId = catchAsync(async(req, res, next) => {
    let body = JSON.stringify([
        '1.216399804', '1.216399460',
        '1.216400220', '1.216400097',
        '1.216402539', '1.216393552',
        '1.216398758', '1.216287960',
        '1.216319849', '1.216392180',
        '1.216329882', '1.216386900',
        '1.216386810', '1.216404935',
        '1.216327475', '1.216239926',
        '1.216240034', '1.216221951',
        '1.216394258', '1.216240142',
        '1.216200911', '1.216239709',
        '1.216334669', '1.216354616'
      ]);
    // console.log(body)
...
exports.getMarketResult = catchAsync(async(req, res, next) => {
    let body = JSON.stringify(["4.1090654685-OE", "4.1720739439-OE"]);
    // console.log(body)
