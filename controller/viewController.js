...
exports.gameReportPageByMatchByMarket = catchAsync(async(req, res, next) => {
    ...
    let oldurl = `/admin/gamereport/match/?userName=${req.query.userName}`
...
exports.gameReportPageFinal = catchAsync(async(req, res, next) => {
    ...
    let oldurl1 = `/admin/gamereport/match?userName=${req.query.userName}`
...
exports.getMarketResult = catchAsync(async(req, res, next) => {
    let body = JSON.stringify(["4.1696779664635-OE", "4.1696912456680-F2"]);
    // console.log(body)
